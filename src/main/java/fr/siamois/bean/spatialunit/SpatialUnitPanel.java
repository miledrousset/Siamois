...
public class SpatialUnitPanel extends AbstractPanel {
    ...
    public SpatialUnitPanel(SpatialUnitService spatialUnitService, RecordingUnitService recordingUnitService, ActionUnitService actionUnitService, HistoryService historyService, SessionSettings sessionSettings, Long id) {
