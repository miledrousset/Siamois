...
(
    ...
    fk_spatial_unit_id  BIGINT NOT NULL, -- dans quelle unité spatiale cette UE se trouve?
...
(
    ...
    author                  BIGINT, -- TODO : link to author or user
...
(
    ...
    fk_recording_unit_id BIGINT,
    fk_ark_id            VARCHAR UNIQUE NOT NULL,
    -- todo : morphometrie BIGINT ?
    fk_specimen_category BIGINT,
    -- todo : traitement BIGINT
    fk_collection_method BIGINT,         -- todo : faut il deux champs? il est ecrit COMMENT et POURQUOI dans le miro
    collection_date      TIMESTAMPTZ, -- quand a il été prelevé
    fk_action_unit_id    BIGINT,
    fk_author_id         BIGINT NOT NULL,
    coordinates          GEOMETRY(Point) NOT NULL, -- coordonée du prelevement
    -- pas besoin de : "fk_spatial_unit_id   BIGINT," on le connait déjà via l'UE
...
(
    ...
    --author   BIGINT, -- TODO : Lien avec auteur
    study_date           TIMESTAMPTZ,
    fk_ark_id            VARCHAR UNIQUE NOT NULL,
    fk_method            BIGINT,
    fk_specimen_group_id BIGINT,
